...
//	public static String senderAddress = "xxx@163.com";
    public static String senderAddress = "";//"liuzhuangjob@163.com";
    //收件人地址
//	public static String recipientAddress = "xxx@qq.com";
    public static String recipientAddress = "";//"liuzhuang@19pay.com.cn";
    //发件人账户名
    //public static String senderAccount = "xxx";
    public static String senderAccount = "liuzhuangjob@163.com";
    //发件人账户密码
    public static String senderPassword = "";//

    public static String bussinessName = "";

    public SendMailText(Properties properties) {
        ...
        this.recipientAddress = properties.getProperty("business.fail.mail");
    ...
    public static MimeMessage getMimeMessage(Session session) throws Exception {
        ...
        //设置邮件正文
        msg.setContent(bussinessName + "邮件发送失败！", "text/html;charset=UTF-8");
        //设置邮件的发送时间,默认立即发送
